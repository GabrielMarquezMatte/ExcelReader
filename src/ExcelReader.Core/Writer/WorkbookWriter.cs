...
namespace ExcelReader.Core.Writer
{
    public sealed class WorkbookWriter : IAsyncDisposable
    {
        [SuppressMessage("SharpSource", "SS066:DisposableFieldIsNotDisposed",
            Justification = "ZipArchive is disposed in EndAsync/DisposeAsync.")]
        ...
        [SuppressMessage("AsyncFixer", "AsyncFixer02:Long-running or blocking operation invoked inside an async method",
            Justification = "ZipArchiveEntry.Open() and StreamWriter.Dispose() are used synchronously; async alternatives do not reliably close the ZIP entry in .NET 10.")]
        ...
        [SuppressMessage("Design", "MA0051:Method is too long",
            Justification = "Builds minimal styles.xml in one pass; splitting adds no clarity.")]
        [SuppressMessage("IDisposableAnalyzers.Correctness", "IDISP001:Dispose created",
            Justification = "Stream is disposed indirectly by StreamWriter with leaveOpen: false.")]
        [SuppressMessage("AsyncFixer", "AsyncFixer02:Long-running or blocking operation invoked inside an async method",
            Justification = "ZipArchiveEntry.Open() and StreamWriter.Dispose() are used synchronously; async alternatives do not reliably close the ZIP entry in .NET 10.")]
