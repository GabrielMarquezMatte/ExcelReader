...
namespace ExcelReader.Core.Writer
{
    ...
    /// <remarks>Mirrors <see cref="Reader.CsvReaderOptions"/> property for property, so a file written with
    ...
    public sealed record CsvWriterOptions
    {
        ...
        /// <remarks>Counterpart to <see cref="Reader.CsvReaderOptions.Encoding"/>: fields are always formatted
        ...
        /// <remarks>Counterpart to <see cref="Reader.CsvReaderOptions.DetectEncodingFromByteOrderMark"/>. Writing
