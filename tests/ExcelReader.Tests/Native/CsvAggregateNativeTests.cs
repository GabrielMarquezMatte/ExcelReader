...
namespace ExcelReader.Tests.Native
{
    public sealed unsafe class CsvAggregateNativeTests
    {
        ...
        public void AggregateCsvMemory_Should_Clear_A_Previous_Error_On_Success()
        {
            ...
            fixed (byte* data = csv)
            {
                int status = CsvAggregateApi.AggregateCsvMemory(data, csv.Length, TallyAggregation(&tally), null, out nint result);
        ...
        public void AggregateCsvMemory_Should_Free_A_State_Whose_Seed_Failed_After_Allocating()
        {
            ...
            fixed (byte* data = csv)
            {
                ...
                int status = CsvAggregateApi.AggregateCsvMemory(data, csv.Length, aggregation, options, out nint result);
        ...
        public void AggregateCsvMemory_Should_Not_Free_A_Null_State()
        {
            ...
            fixed (byte* data = csv)
            {
                ...
                int status = CsvAggregateApi.AggregateCsvMemory(data, csv.Length, aggregation, null, out nint result);
